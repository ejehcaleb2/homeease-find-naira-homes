...
const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-light overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-primary/10 rounded-full -translate-y-32 translate-x-32"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-secondary/10 rounded-full translate-y-32 -translate-x-16"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="relative">
                ...
                <Select value={searchData.propertyType} onValueChange={(value) => setSearchData({...searchData, propertyType: value})}>
                  <SelectTrigger className="pl-10 h-12 border-gray-200 focus:border-primary">
        ...
        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-center animate-fade-in-up" style={{animationDelay: '0.6s'}}>
          <div>
